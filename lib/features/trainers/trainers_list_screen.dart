            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('providerServiceTypes', arrayContains: 'Training')
                    .snapshots(),
                builder: (context, snapshot) {
                  ...
                  if (docs.isEmpty) {
                    return const ProviderEmptyState(
                      ...
                      message:
                          'No trainers yet.\nBe the first to offer training services!',
                    );
                  }
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final prices = Map<String, dynamic>.from(
                          d['providerPrices'] ?? {});
                      final price = prices['Training'] != null
                          ? 'R${prices['Training']}'
                          : (d['providerRate'] as String? ?? '');
                      return ProviderTile(
                        uid: uid,
                        name: d['displayName'] as String? ?? 'Trainer',
