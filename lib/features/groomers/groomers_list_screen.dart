...
class GroomersListScreen extends StatefulWidget {
  const GroomersListScreen({super.key});
  @override
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('providerServiceTypes', arrayContains: 'Grooming')
                    .snapshots(),
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final prices = Map<String, dynamic>.from(
                          d['providerPrices'] ?? {});
                      final price = prices['Grooming'] != null
                          ? 'R${prices['Grooming']}'
                          : (d['providerRate'] as String? ?? '');
                      return ProviderTile(
                        uid: uid,
                        name: d['displayName'] as String? ?? 'Groomer',
