...
class SittersListScreen extends StatefulWidget {
  const SittersListScreen({super.key});
  @override
  State<SittersListScreen> createState() => _SittersListScreenState();
}

class _SittersListScreenState extends State<SittersListScreen> {
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('providerServiceTypes', arrayContains: 'Sitting')
                    .snapshots(),
                builder: (context, snapshot) {
                  ...
                  if (docs.isEmpty) {
                    return const ProviderEmptyState(
                      ...
                      message:
                          'No sitters yet.\nBe the first to offer sitting services!',
                    );
                  }
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final prices = Map<String, dynamic>.from(
                          d['providerPrices'] ?? {});
                      final price = prices['Sitting'] != null
                          ? 'R${prices['Sitting']}'
                          : (d['providerRate'] as String? ?? '');
                      return ProviderTile(
                        uid: uid,
                        name: d['displayName'] as String? ?? 'Sitter',
