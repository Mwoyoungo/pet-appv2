...
class BehavioristListScreen extends StatefulWidget {
  const BehavioristListScreen({super.key});

  @override
  State<BehavioristListScreen> createState() => _BehavioristListScreenState();
}

class _BehavioristListScreenState extends State<BehavioristListScreen> {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Expert pet behaviour consultants',
                        style: GoogleFonts.inter(
                          fontSize: 12,
                          color: isDark
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final prices = Map<String, dynamic>.from(
                          d['providerPrices'] ?? {});
                      final price = prices['Behaviorist'] != null
                          ? 'R${prices['Behaviorist']}'
                          : (d['providerRate'] as String? ?? '');
                      return ProviderTile(
                        uid: uid,
                        name: d['displayName'] as String? ?? 'Behaviorist',
